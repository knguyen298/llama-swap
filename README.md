...
- ✅ API Key support - define keys to restrict access to API endpoints
  - `auth.ui: none` hands web UI login to a reverse proxy (Authelia, oauth2-proxy) while `/v1/` keeps requiring a key, see [API keys and access control](docs/kb/guides/api-integration/api-keys-and-auth.md)
- ✅ Customization
